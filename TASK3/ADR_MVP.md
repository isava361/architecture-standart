...
1. Доработка монолита интернет-банка: Рассмотрели вариант реализовать всю логику внутри существующего интернет-банка, но это влечет усиление зависимости от подрядчика, невозможность горизонтального масштабирования, риск дестабилизации существующего функционала, технологические ограничения (.NET 4.5).
